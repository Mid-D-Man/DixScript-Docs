<script lang="ts">
  ...
  const columns = [
    ...
    },
    {
      title: 'Community',
      links: [
        { label: 'GitHub',  href: 'https://github.com/Mid-D-Man/DixScript-Rust', external: true },
        { label: 'Issues',  href: 'https://github.com/Mid-D-Man/DixScript-Rust/issues', external: true },
      ],
    },
  ];
</script>
